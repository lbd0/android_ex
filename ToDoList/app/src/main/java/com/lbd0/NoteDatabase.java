...
public class NoteDatabase {
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String CREATE_SQL = "CREATE TABLE " + TABLE_NOTE + "(" + " _id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, " + "TODO TEXT DEFAULT '' " + ");";
            ...
            String CREATE_INDEX_SQL = "CREATE INDEX " + TABLE_NOTE + "_IDX ON " + TABLE_NOTE + "(" + "_id" + ")";
